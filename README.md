...
| 项目 | 状态 | 完成效果 |
|------|------|----------|
| 免费路线额度 | ✅ 已完成 | 每个产品行程提供 1 次完整粗路线 + 2 次调整；管理员不受限制 |
| 专业路线 ¥9.9 | ✅ MVP 已完成 | 免费版不截断；付费增加核验顺序、车程、到达时间、预约、预算、雨天备选和司机行程单 |
| 人工收款确认 | ✅ 已完成 | 用户提交付款待确认订单，管理员在 AI 工具账户中心确认到账并解锁 |
| 邀请积分 | ✅ 已完成 | 邀请者 10 分、受邀者 5 分，24 小时后生效；30 分兑换一次专业路线，每月最多计 5 位有效邀请 |
| 巴厘岛路线体系 | ✅ 第一版 | G1–G7 地理事实层 + R1–R6 主题路线家族；移动端可横向浏览，路线先于作品集 |
| 本地司机 | ✅ 第一版 | Dicky / Gede 可选，展示车辆和游客实拍；价格由司机结合路线与日期报价，不展示未经确认的固定价 |
| 图片治理 | ✅ 工具与台账 | 106 张图片生成候选分类、尺寸、哈希和版权复核表；水印或来源不明图片默认不发布 |
