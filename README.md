...
| 巴厘岛路线体系 | ✅ 第一版 | G1–G7 地理事实层 + R1–R6 主题路线家族；62 个 POI 中 56 个稳定事实已核验、3 个待确认规范身份、3 个受供应商门禁；移动端可横向浏览，路线先于作品集 |
...
| 1 · P0 | **巴厘岛剩余 POI 来源复核** | R1 主干、R2、R3、R4 与 R6 的免费路线稳定事实已核验；分支全库现为 62 个 POI：56 个 `verified`、3 个 `pending_review`、3 个 `needs_supplier_confirmation`。本轮新增 Pura Taman Ayun、Pura Taman Saraswati 与 Sundays Beach Club 的官方/政府/国际遗产来源和实时检查边界；Thousand Islands Viewpoint、Mount Batur 徒步入口和 Batur 温泉仍须先确定唯一规范身份、入口或场所。验收：公开路线引用的稳定事实有官方/政府或场所一手来源，营业时间、票价、课程、仪式、火山状态、天气、水况、船班与交通继续在出发前实时复核 |
