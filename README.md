...
| 4 · P1 | **批量 Portfolio 治理** | 首图生产生命周期已闭环；两批共 21 张 D8 图片已补齐中/英/日/韩/印五语言标题、说明和替代文本。第二批 6 张覆盖 Lempuyang、Taman Ayun、Taman Saraswati 与 Sundays Beach Club，并通过原图哈希匹配与 390/768/1440 响应式自动填充验收。剩余 31 张 D8 候选仍需按地点证据、路线关联和五语言资料分批审核；未确认素材不可发布，公开 API 与 UI 数量口径必须一致 |
