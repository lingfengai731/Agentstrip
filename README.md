...
| 13 · P1 | **微信小程序 v1 与发布门禁** | v1 已接入邮箱/微信统一身份、验证码、AI、R1–R6、专业路线权益、历史、无邮箱司机中转和微信官方内容安全核验。站主已在真机 Preview 验收无白屏、品牌名、错误密码、邮箱登录和微信一键登录；本轮进一步统一 teal + gold 视觉、手机触控尺寸、按钮居中和页面文案，新的设计版仍待站主扫码复验。未上传、未提审、未发布 |
