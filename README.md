...
| 🚗 找司机 | Dicky / Gede 可选；五语透明参考预算器按已确认的全天/半天基线计算，隐私表单按所选司机转发，网站不公开司机个人邮箱、微信或 WhatsApp | ✅ 代码与本地测试 |
...
| 3 · P0 | **Dicky / Gede 路线级报价** | 已实现五语全天/半天参考预算器：全天 70 万印尼盾基础价、半天 50 万印尼盾基础价，均按每位游客每天增加 5 万印尼盾；它不写入邮件、不声称最终价。逐司机适用范围、佩妮达船车衔接、机场/换酒店、超时、区域与活动附加费仍待授权。验收：按司机、日期、时长、区域和路线版本化计算，且司机最终确认前不声称成交价 |
