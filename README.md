...
| 4 · P1 | **批量 Portfolio 治理** | 首图生产生命周期已闭环；当前 27 张 D8 图片已补齐中/英/日/韩/印五语言标题、说明和替代文本。`bali-12.jpg` 已关联乌布圣猴森林，`bali-3.jpg` 已由标志性岬角影像与政府/国家旅游资料关联 Kelingking Beach Viewpoint；`Nyepi.jpg` 已纠正为塞米亚克村社神庙的社区文化聚会；`bali-1.jpg` 与 `bali-2.jpg` 因缺少唯一地点证据保持未知地点且不开放 AI/司机交接。剩余 25 张仍按地点证据、路线关联和五语言资料分批审核。未确认素材不可发布，公开 API 与 UI 数量口径必须一致 |
