...
| 优先级 | 内容 | 说明 |
|--------|------|------|
| 🟡 内容核验 | **巴厘岛 POI 逐条来源复核** | R1 主干已有 15 个地点用官方场馆或印尼政府来源核验稳定身份、位置和访客背景；34 个仍为 `pending_review`，火山 Jeep 单独标记为 `needs_supplier_confirmation`；营业时间、票价、仪式、天气与交通继续要求出发前实时复核 |
