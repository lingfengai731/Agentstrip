...
| 4 · P1 | **批量 Portfolio 治理** | 首图生产生命周期已闭环；三批共 22 张 D8 图片已补齐中/英/日/韩/印五语言标题、说明和替代文本。第三批首个单元以原图哈希、官方场所资料及同一入口影像确认 `bali-12.jpg` 对应乌布圣猴森林，并关联 G4、R1/R2/R4；剩余 30 张仍按地点证据、路线关联和五语言资料分批审核。未确认素材不可发布，公开 API 与 UI 数量口径必须一致 |
