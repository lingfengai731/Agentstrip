...
| 巴厘岛路线体系 | ✅ 第一版 | G1–G7 地理事实层 + R1–R6 主题路线家族；59 个 POI 中 53 个稳定事实已核验、3 个待确认规范身份、3 个受供应商门禁；移动端可横向浏览，路线先于作品集 |
...
| 4 · P1 | **批量 Portfolio 治理** | 首图生产生命周期已闭环；当前 26 张 D8 图片已补齐中/英/日/韩/印五语言标题、说明和替代文本。`bali-12.jpg` 已由影像证据关联乌布圣猴森林；`Nyepi.jpg` 已按门牌纠正为塞米亚克村社神庙的社区文化聚会；`bali-1.jpg` 因无唯一地点证据按未知地点的暮色礁石海岸记录；`bali-2.jpg` 虽与 Handara Gate 视觉相似，但缺少唯一地点证据，因此仅记录为地点未知的巴厘式分体门。后三者不绑定未核实 POI，也不开放 AI/司机交接。剩余 26 张仍按地点证据、路线关联和五语言资料分批审核。未确认素材不可发布，公开 API 与 UI 数量口径必须一致 |
