...
| 中文合并审阅手册 | ✅ 已通过 | 站长于 2026-08-27 确认 Dicky、Gede Nico 两份手机友好的合并手册内容通过；正式印尼语版进入最终生成与逐页验收，不把生成中状态写成已交付 |
| 首屏氛围动效 | ✅ 本地完成 | 首页与巴厘岛首屏增加一层 teal + gold 晨光漂移；仅桌面/平板缓慢运行，手机和减少动态效果模式保持静态；未向登录、支付和后台扩散 |
| PayPal 沙盒准备 | ✅ 指南已更新 | 已按中国大陆个人卖家、中国大陆结算银行账户和 CNY 9.90 专业路线试点整理开户、Sandbox、webhook 与 Render 环境变量步骤；生产自动支付仍保持独立门禁 |
| Batur Jeep 候选 | ⏳ 待核验 | Dicky 推荐 Pak Nanok Jeep Bali Tour，已作为内部候选登记；在联系方式、主体、车辆、安全、保险、路线与价格闭环前不公开作为官方推荐 |
...
| 🏝️ 巴厘岛 Portfolio | R1–R6 公共路线 + 专业路线预览/解锁 + 62/62 POI 视觉预览 + 8 个一至两日体验套餐 + 找司机 CTA | ✅ 本地完成，待部署 |
| 🔎 全站搜索 | 7 个公开页统一入口；检索页面、R1–R6 和 62 个 POI，支持五语言、GET 分享、键盘与手机 | ✅ 本地完成，待部署 |
