...
| 13 · P1 | **微信小程序 v1 与发布门禁** | v1 已接入账号、验证码、AI、R1–R6、专业路线权益、历史与司机交接；2026-09-02 增加微信官方内容安全核验，用户资料和文本完整分块、失败关闭。站主确认 request 合法域名、隐私与 UGC 声明已完成；仍需在 Render 直接配置两项微信服务端凭据并部署，再单独决定真机预览。未上传、未提审、未发布 |
