...
| 4 · P1 | **批量 Portfolio 治理** | 首图生产生命周期已闭环；当前 25 张 D8 图片已补齐中/英/日/韩/印五语言标题、说明和替代文本。`bali-12.jpg` 已由影像证据关联乌布圣猴森林；`Nyepi.jpg` 已按门牌纠正为塞米亚克村社神庙的社区文化聚会；`bali-1.jpg` 因无唯一地点证据已移除 Bali 断言，按未知地点的暮色礁石海岸记录。后两者均不绑定 POI，也不开放 AI/司机交接。剩余 27 张仍按地点证据、路线关联和五语言资料分批审核。未确认素材不可发布，公开 API 与 UI 数量口径必须一致 |
