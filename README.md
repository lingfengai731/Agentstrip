...
| 优先级 | 内容 | 说明 |
|--------|------|------|
| 1 · P0 | **巴厘岛剩余 POI 来源复核** | R1 主干、R2、R3、R4 与 R6 的免费路线稳定事实已核验；本轮新增核验 Ulun Danu Beratan、Tegenungan、Jatiluwih、Lempuyang、Taman Ujung 与 Virgin Beach，明确 Ubud/Bedugul 路线分组不等于行政位置，Lempuyang 拍照门区不等于山顶寺庙。Mount Batur 徒步入口和 Batur 温泉因对应多个入口/运营场所继续待审，Jeep 继续供应商门禁；Dicky 五日路线已补入 Suluban 和佩妮达东西线。全库现为 59 个 POI：48 个 `verified`、8 个 `pending_review`、3 个 `needs_supplier_confirmation`。验收：公开路线引用的稳定事实有官方/政府或场所一手来源，营业时间、票价、课程、仪式、火山状态、天气、水况、船班与交通继续在出发前实时复核 |
