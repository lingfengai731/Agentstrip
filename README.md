...
| 优先级 | 内容 | 说明 |
|--------|------|------|
| 1 · P0 | **巴厘岛剩余 POI 来源复核** | R1 主干、R3、R4 与 R6 的免费路线稳定事实已核验；Dicky 五日路线补入 Suluban 和佩妮达东西线。全库现为 59 个 POI：35 个 `verified`、21 个 `pending_review`、3 个 `needs_supplier_confirmation`。验收：公开路线引用的稳定事实有官方/政府来源，营业时间、票价、仪式、天气、船班与交通继续在出发前实时复核 |
