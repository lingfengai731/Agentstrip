...
Latest release follow-up: PR88fixed`c4a388f` passedMiniCI34803973836/ProjectmemoryCI34803973814 andmerged`main@2ec5319`;wholeGit tree8cedd17 andMini c087c61 match. OfficialWeChatCLI developerUpload`0.1.0` succeeded,1,719,880bytes. NOTsubmittedforreview orpublicrelease;actualWeChatconsoleconfiguration/ownerphoneacceptance remainunverified. Read `.codex/project-memory/handoffs/2026/09/20260914T035410Z-mini-upload-media-audit.md`. Luna readonlysupplied68originals+68web/34venuehash auditaccepted;63ownerpermissionassertions remainunproved,4Commonslicense/source-supportedcandidates and1exactSeminyakbranchpending;0newimagesapproved/published. Inputrestaurant-mediaandrawoutputlocaluntrackednotshared. Prioritynow:WeChatconsole0.1.0/category/privacy/domain/testaccessreview-readiness;imagesnonblocking. Earlierdated/preuploadsectionsbelowarehistorical.

Current follow-up: user reported all six Mini Dining selectors unresponsive on phone. Isolated `codex/mini-food-filter-release-20260914` starts at merged `main@3248f2b`; original dirty checkout and supplied `restaurant-media/` preserved. Six explicit filter buttons/bottom-sheet options replace native pickers;386 contracts/all offline Mini suites pass.30 native SDK actual button taps (6×5 locales),44px controls,0 exceptions and separate36-option scroll/last-selection/backdrop lane pass. OfficialPreview1,719,880bytes; not Upload/review/public release. Source receipt `.codex/project-memory/handoffs/2026/09/20260914T034930Z-mini-food-filter-release.md`. Supplied68photo/34venue pack remains candidates;63official authorization assertions not accepted as proof. Priority: fixedheadCI/merge → developer-version Upload for requested Mini申报 → console review prerequisites; photoexpansion does not block firstrelease. Underlying phone native-picker cause was not established.

PR86 fixed `ab0a22d` passes3requiredCI and is merged as `bce613b`;wholeGit tree324e449 matches. OfficialMiniPreview1716399bytes generated frommatchingMini subtreeed78970 (notUpload/review/publicrelease).383offlinecontracts/31localweb/nativeFood5locales390px44px/professionalprivatecallbacks remainaccepted. Publicdeterministic20Foodcases×5languages/4widths andseparate2crediteddecodedPortfolio photos pass;newFood/extensions/taxonomyLFnormalizedparity,2WebPsexactbinaryparity. Newphotos2approved/2contextverified/2publicdisplayed;oldmanifestpending_deploymarkersnotrewrittenbyreceipt. Food50(40editorial/10draft),18identitychecks;operatingfacts/storefrontsbounded. NativeEdgebootstrapnode:processrejects;Renderdeploymentid/exactcommit/nativeBrowseradministrativeacceptanceunknown,NOT inferredfromservedcontent. PlannerSDKeventcallbacks≠physical-phone touch. Read `.codex/project-memory/handoffs/2026/09/20260914T014307Z-pr86-merge-preview-public.md`. Activecleanreceiptbranchcodex/bali-food-release-receipt-20260914 isbasedonmergedmain;rawoutput/QRslocalonly;originalcheckoutuntouched. Nextsafework:licensedrestaurantstorefrontsourceaudit/32remainingdirectidentitychecks. Existingowner-acceptedfirstlaunchcandidatecanproceedindependently;noUpload/review/publicreleaseclaimed. Datedsectionsbelowarehistorical.
