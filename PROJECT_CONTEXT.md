...
Draft PR86 remains NOT merged/deployed. Native fixes `a10ce25` and receiver-test refinement `03e672f` are pushed. The old trust/port-only gate is superseded: Food WXML compiled after operator/conditional fixes, and reserved Page.route collision was removed without changing SDK or security settings. Native Food five locales at390px:12candidates/37buttons/min44px;3modules make11separate days, day9 Penida Colada saves/readbacks, AI receives963character editable draft without auto send. Frozen web31/backend123 and380offline Mini contracts remain accepted. Required cloud CI passes at `a10ce25`; later head status requires fresh receipt. Next: native-professional-driver-receiver-acceptance with local mocks, no live order/mail. Main last verified `88fc025` is the separate accepted Mini candidate. Data:66canonical POIs/4activity POIs/3extensions;50Food (40editorial/10draft),18direct identity checks, no operating guarantees. New2licensed contextual photos approved/context-verified,production-published0. Read `.codex/project-memory/handoffs/2026/09/20260913T132400Z-native-food-receivers.md` and linked evidence. Dated sections below are historical; no new Preview/Upload/review/public release claimed.
