...
Code `68ff437` and test repair `ea6863c` are pushed on `codex/bali-extensions-food-20260913`, NOT merged or deployed. Main last verified `88fc025` remains the separate owner-accepted Mini candidate. Next exact action: native-food-final-acceptance after the owner trusts/runs the isolated project; one bounded SDK retry timed out, empty native matrix is not accepted evidence. Accepted:31 local deterministic Chromium callbacks,380 Mini contracts/offline suites,123 backend tests. Data:3 Penida modules,1 new canonical POI,4 activity POIs,50 Food records (40 eligible /10 draft),18 directly source-checked restaurant identities (not operational guarantees). Two licensed real contextual photos approved and locally integrated; production-published0. Follow `.codex/project-memory/handoffs/2026/09/20260913T130613Z-bali-food-media-callbacks.md` and linked evidence. Dated sections below are historical, not proof of this expansion's release.
