...
const LANGS = {
  en: {
    ...
    fdContact: 'Your contact', fdContactHint: 'Provide at least one so the selected driver can reach you.',
    ...
    fdSuccessSub: 'Your request was sent for driver review. The selected driver or WanderMind will reply using the contact you provided.',
  ...
  zh: {
    ...
    fdContact: '你的联系方式', fdContactHint: '至少填一项，方便所选司机联系你。',
    ...
    fdSuccessSub: '需求已进入司机确认流程，所选司机或 WanderMind 会通过你提供的联系方式回复。',
  ...
  ja: {
    ...
    fdContact: 'ご連絡先', fdContactHint: '選択したドライバーが連絡できるよう、最低1つご記入ください。',
    ...
    fdSuccessSub: 'ドライバー確認に送信されました。選択したドライバーまたはWanderMindがご記入の連絡先へ返信します。',
  ...
  ko: {
    ...
    fdContact: '연락처', fdContactHint: '선택한 기사가 연락할 수 있도록 최소 하나는 입력해 주세요.',
    ...
    fdSuccessSub: '기사 검토 요청이 전송되었습니다. 선택한 기사 또는 WanderMind가 입력한 연락처로 답변합니다.',
  ...
  id: {
    ...
    fdContact: 'Kontak Anda', fdContactHint: 'Isi minimal satu agar driver pilihan dapat menghubungi Anda.',
    ...
    fdSuccessSub: 'Permintaan dikirim untuk ditinjau. Driver pilihan atau WanderMind akan membalas melalui kontak Anda.',
