...
const LANGS = {
  en: {
    ...
    srvHeaderTitle: 'Choose how you want to plan',
    srvHeaderSub: 'Start with a checked Bali route, build your own with AI, or bring a ready plan to a local driver.',
    srv1Title: 'Bali professional route',
    srv1Desc: 'Match a practical Bali route to your dates, pace and budget. Preview about 70%, then unlock the complete route when it fits.',
    srv1Meta: '70% preview · ¥9.9 or 30 points · 3 adjustments',
    srv1Btn: 'See professional routes',
    srv2Title: 'AI self-planning',
    srv2Desc: 'Build and edit the trip yourself with the AI workspace. Your AI allowance is separate from professional-route access.',
    srv2Meta: 'Free allowance · Any destination · You stay in control',
    srv2Btn: 'Open AI planner',
    srv3Title: 'Local driver handoff',
    srv3Desc: 'When the route is ready, send dates, group size and budget through WanderMind. The selected driver replies with availability and the final quote.',
    srv3Meta: 'Private email handoff · No direct contact details · Not instant booking',
    srv3Btn: 'Contact a Bali driver',
    srvDestTitle: 'Start with Bali. Use AI for other cities.',
    srvDestSub: 'Bali has free public routes, professional-route previews and a local-driver handoff. Other cities open as editable AI starting points.',
    srvDestBali: 'Bali · Indonesia',
    srvDestBaliDesc: '6 free route families · Professional preview · Local driver handoff',
    srvDestBaliBtn: 'Explore Bali',
    srvDestKyoto: 'Kyoto · Japan',
    srvDestKyotoDesc: 'Open an editable AI starting point',
    srvDestParis: 'Paris · France',
    srvDestParisDesc: 'Open an editable AI starting point',
    srvDestSant: 'Santorini · Greece',
    srvDestSantDesc: 'Open an editable AI starting point',
    srvDestAny: 'Any city',
    srvDestAnyDesc: 'Start with AI, then verify live details',
    srvDestMoreDesc: 'More destination research will be added only after verification.',
  ...
  zh: {
    ...
    srvHeaderTitle: '选择适合你的规划方式',
    srvHeaderSub: '先看经过整理的巴厘岛路线，用 AI 自己规划，或把已经确定的路线交给当地司机协助落地。',
    srv1Title: '巴厘岛专业路线',
    srv1Desc: '根据日期、节奏和预算匹配可执行的巴厘岛路线。先预览约 70%，确认合适后再解锁完整路线。',
    srv1Meta: '约 70% 预览 · ¥9.9 或 30 积分 · 3 次调整',
    srv1Btn: '查看专业路线',
    srv2Title: 'AI 自助规划',
    srv2Desc: '在 AI 工作台中自己生成和修改行程。AI 使用额度与专业路线权益完全独立。',
    srv2Meta: '含免费额度 · 支持任意目的地 · 全程由你掌控',
    srv2Btn: '打开 AI 规划器',
    srv3Title: '当地司机协助',
    srv3Desc: '路线确定后，通过 WanderMind 提交日期、人数和预算。所选司机会回复档期与最终报价。',
    srv3Meta: '邮件私密转发 · 不公开司机联系方式 · 不是即时预订',
    srv3Btn: '联系巴厘岛司机',
    srvDestTitle: '先从巴厘岛开始，其他城市可用 AI 自助规划',
    srvDestSub: '巴厘岛提供免费公共路线、专业路线预览和当地司机交接；其他城市先作为可编辑的 AI 规划起点。',
    srvDestBali: '巴厘岛 · 印度尼西亚',
    srvDestBaliDesc: '6 条免费公共路线 · 专业路线预览 · 当地司机交接',
    srvDestBaliBtn: '探索巴厘岛',
    srvDestKyoto: '京都 · 日本',
    srvDestKyotoDesc: '打开可编辑的 AI 规划起点',
    srvDestParis: '巴黎 · 法国',
    srvDestParisDesc: '打开可编辑的 AI 规划起点',
    srvDestSant: '圣托里尼 · 希腊',
    srvDestSantDesc: '打开可编辑的 AI 规划起点',
    srvDestAny: '任意城市',
    srvDestAnyDesc: '先用 AI 规划，预订前再核验实时信息',
    srvDestMoreDesc: '更多目的地只会在完成核验后加入。',
  ...
  ja: {
    ...
    srvHeaderTitle: '自分に合う計画方法を選ぶ',
    srvHeaderSub: '確認済みのバリルートから始める、AIで自分で組む、または完成した計画を現地ドライバーにつなげます。',
    srv1Title: 'バリ島のプロルート',
    srv1Desc: '日程、ペース、予算に合う実用的なバリルートを提案。約70%を確認し、合えば完全版を解除できます。',
    srv1Meta: '約70%プレビュー · ¥9.9 または30ポイント · 3回調整',
    srv1Btn: 'プロルートを見る',
    srv2Title: 'AIセルフプランニング',
    srv2Desc: 'AIワークスペースで自分で旅程を作成・編集。AI利用枠はプロルートの権利とは別です。',
    srv2Meta: '無料枠あり · どの目的地にも対応 · 自分で調整',
    srv2Btn: 'AIプランナーを開く',
    srv3Title: '現地ドライバーへの引き継ぎ',
    srv3Desc: 'ルートが決まったら、日程、人数、予算をWanderMind経由で送信。選択したドライバーが空き状況と最終料金を返信します。',
    srv3Meta: 'メールで非公開転送 · 直接連絡先は非公開 · 即時予約ではありません',
    srv3Btn: 'バリのドライバーに相談',
    srvDestTitle: 'まずバリから。ほかの都市はAIで。',
    srvDestSub: 'バリには無料公開ルート、プロルートのプレビュー、現地ドライバーへの引き継ぎがあります。ほかの都市は編集可能なAIプランの出発点です。',
    srvDestBali: 'バリ島 · インドネシア',
    srvDestBaliDesc: '6つの無料公開ルート · プロルートプレビュー · 現地ドライバー連携',
    srvDestBaliBtn: 'バリを探索',
    srvDestKyoto: '京都 · 日本',
    srvDestKyotoDesc: '編集可能なAIプランを開く',
    srvDestParis: 'パリ · フランス',
    srvDestParisDesc: '編集可能なAIプランを開く',
    srvDestSant: 'サントリーニ · ギリシャ',
    srvDestSantDesc: '編集可能なAIプランを開く',
    srvDestAny: 'すべての都市',
    srvDestAnyDesc: 'AIで始め、予約前に最新情報を確認',
    srvDestMoreDesc: 'ほかの目的地は確認が完了してから追加します。',
  ...
  ko: {
    ...
    srvHeaderTitle: '나에게 맞는 여행 계획 방식을 선택하세요',
    srvHeaderSub: '검토된 발리 경로로 시작하거나, AI로 직접 계획하거나, 완성된 계획을 현지 기사에게 전달하세요.',
    srv1Title: '발리 전문 경로',
    srv1Desc: '날짜, 속도, 예산에 맞는 실행 가능한 발리 경로를 매칭합니다. 약 70%를 먼저 보고 적합할 때 전체 경로를 해제하세요.',
    srv1Meta: '약 70% 미리보기 · ¥9.9 또는 30포인트 · 3회 조정',
    srv1Btn: '전문 경로 보기',
    srv2Title: 'AI 셀프 플래닝',
    srv2Desc: 'AI 작업 공간에서 직접 일정을 만들고 수정합니다. AI 사용 한도는 전문 경로 권한과 별도입니다.',
    srv2Meta: '무료 한도 포함 · 모든 목적지 · 직접 조정',
    srv2Btn: 'AI 플래너 열기',
    srv3Title: '현지 기사 연결',
    srv3Desc: '경로가 준비되면 날짜, 인원, 예산을 WanderMind로 보냅니다. 선택한 기사가 가능 일정과 최종 견적을 답변합니다.',
    srv3Meta: '비공개 이메일 전달 · 직접 연락처 비공개 · 즉시 예약 아님',
    srv3Btn: '발리 기사에게 문의',
    srvDestTitle: '발리부터 시작하고, 다른 도시는 AI로 계획하세요',
    srvDestSub: '발리는 무료 공개 경로, 전문 경로 미리보기, 현지 기사 연결을 제공합니다. 다른 도시는 편집 가능한 AI 계획의 출발점입니다.',
    srvDestBali: '발리 · 인도네시아',
    srvDestBaliDesc: '무료 공개 경로 6개 · 전문 경로 미리보기 · 현지 기사 연결',
    srvDestBaliBtn: '발리 탐색',
    srvDestKyoto: '교토 · 일본',
    srvDestKyotoDesc: '편집 가능한 AI 계획 열기',
    srvDestParis: '파리 · 프랑스',
    srvDestParisDesc: '편집 가능한 AI 계획 열기',
    srvDestSant: '산토리니 · 그리스',
    srvDestSantDesc: '편집 가능한 AI 계획 열기',
    srvDestAny: '모든 도시',
    srvDestAnyDesc: 'AI로 시작하고 예약 전 최신 정보 확인',
    srvDestMoreDesc: '다른 목적지는 검증이 끝난 뒤 추가됩니다.',
  ...
  id: {
    ...
    srvHeaderTitle: 'Pilih cara merencanakan perjalanan',
    srvHeaderSub: 'Mulai dari rute Bali yang telah ditinjau, susun sendiri dengan AI, atau teruskan rencana jadi kepada driver lokal.',
    srv1Title: 'Rute profesional Bali',
    srv1Desc: 'Cocokkan rute Bali yang praktis dengan tanggal, ritme, dan anggaran Anda. Lihat sekitar 70%, lalu buka rute lengkap bila sesuai.',
    srv1Meta: 'Pratinjau sekitar 70% · ¥9,9 atau 30 poin · 3 penyesuaian',
    srv1Btn: 'Lihat rute profesional',
    srv2Title: 'Perencanaan mandiri dengan AI',
    srv2Desc: 'Buat dan ubah perjalanan sendiri di ruang kerja AI. Kuota AI terpisah dari hak akses rute profesional.',
    srv2Meta: 'Ada kuota gratis · Semua tujuan · Anda tetap mengendalikan',
    srv2Btn: 'Buka perencana AI',
    srv3Title: 'Teruskan ke driver lokal',
    srv3Desc: 'Saat rute siap, kirim tanggal, jumlah tamu, dan anggaran melalui WanderMind. Driver pilihan membalas ketersediaan dan harga akhir.',
    srv3Meta: 'Diteruskan privat lewat email · Kontak langsung tidak dibuka · Bukan pemesanan instan',
    srv3Btn: 'Hubungi driver Bali',
    srvDestTitle: 'Mulai dari Bali. Gunakan AI untuk kota lain.',
    srvDestSub: 'Bali memiliki rute publik gratis, pratinjau rute profesional, dan penerusan ke driver lokal. Kota lain dibuka sebagai titik awal AI yang dapat diedit.',
    srvDestBali: 'Bali · Indonesia',
    srvDestBaliDesc: '6 rute publik gratis · Pratinjau profesional · Teruskan ke driver lokal',
    srvDestBaliBtn: 'Jelajahi Bali',
    srvDestKyoto: 'Kyoto · Jepang',
    srvDestKyotoDesc: 'Buka titik awal AI yang dapat diedit',
    srvDestParis: 'Paris · Prancis',
    srvDestParisDesc: 'Buka titik awal AI yang dapat diedit',
    srvDestSant: 'Santorini · Yunani',
    srvDestSantDesc: 'Buka titik awal AI yang dapat diedit',
    srvDestAny: 'Kota mana pun',
    srvDestAnyDesc: 'Mulai dengan AI, lalu verifikasi info terbaru sebelum memesan',
    srvDestMoreDesc: 'Riset tujuan lain hanya ditambahkan setelah diverifikasi.',
