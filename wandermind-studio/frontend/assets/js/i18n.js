...
const LANGS = {
  en: {
    ...
    partnerDickyCta: 'Open a private driver request →',
    ...
    fdContactViaForm: "Submit the form on the left and choose a driver — we'll forward your request privately.",
    ...
    baliHeroSub: 'Choose one of six route families, then adjust the days, pace, budget and travel companions so you can feel the island rather than rush through a checklist.',
    ...
    baliItinEyebrow: 'Example route · 12 days', baliItinTitle: 'A deep-route starting point',
    baliItinSub: 'This example balances the coast, culture, volcanoes and an island extension. Use it as a starting point, then tailor it to your constraints.',
    baliDayLbl: 'Days',
    ...
    baliDriverPrice1: 'Trip length confirmed with driver', baliDriverPrice2: 'Quote after route review', baliDriverPrice3: 'Airport & hotel pickup',
    ...
    fdStepTrip: 'Trip', fdStepNeeds: 'Route & needs', fdStepReview: 'Contact & send',
    fdStepTripTitle: 'Start with your trip', fdStepNeedsTitle: 'Shape the route and quote', fdStepReviewTitle: 'Confirm where we should reply',
    fdNext: 'Next', fdBack: 'Back', fdViewDriver: 'View selected driver profile',
    fdChooseDriver: 'Choose a driver', fdDickyShort: 'Local Bali driver', fdGedeShort: 'Local Bali driver',
    ...
    fdContact: 'Your email', fdContactHint: 'Driver requests are handled by email through WanderMind.',
    fdEmailPh: 'Email address',
    ...
    fdConsent: 'I agree that WanderMind may forward this request and the email address I entered to my selected driver to arrange a reply.', fdErrConsent: 'Please confirm that we may forward this request to your selected driver.',
    ...
    fdPriceLine1: '<strong>Quote after route review</strong>',
    fdPriceNote: 'Availability, vehicle, hours and price require driver confirmation.',
    ...
    fdErrName: 'Please enter your name', fdErrContact: 'Please provide an email address',
    fdSending: 'Sending…', fdSuccessTitle: 'Request sent!',
    fdSuccessSub: 'Your request was sent for driver review. The selected driver or WanderMind will reply by email.',
  ...
  zh: {
    ...
    baliHeroSub: '先从六条主题路线中选择，再按天数、节奏、预算和同行者调整，让你真正感受这座岛，而不是匆忙打卡。',
    ...
    baliItinEyebrow: '路线示例 · 12 天', baliItinTitle: '一条深度路线的起点',
    baliItinSub: '这个示例平衡海岸、文化、火山与离岛扩展。请把它当作起点，再根据你的真实限制调整。',
    baliDayLbl: '天',
    ...
    baliDriverPrice1: '用车时长由司机确认', baliDriverPrice2: '司机看过路线后报价', baliDriverPrice3: '机场与酒店接送',
    ...
    fdStepTrip: '行程', fdStepNeeds: '路线与需求', fdStepReview: '联系方式',
    fdStepTripTitle: '先填写基本行程', fdStepNeedsTitle: '补充路线与用车需求', fdStepReviewTitle: '确认回复邮箱并发送',
    fdNext: '下一步', fdBack: '上一步', fdViewDriver: '查看所选司机完整介绍',
    fdChooseDriver: '选择司机', fdDickyShort: '巴厘岛本地司机', fdGedeShort: '巴厘岛本地司机',
    ...
    fdContact: '你的电子邮箱', fdContactHint: '司机需求由 WanderMind 通过邮件转发处理。',
    fdEmailPh: '电子邮箱',
    ...
    fdConsent: '我同意 WanderMind 将本次需求及我填写的电子邮箱转发给所选司机，以便其回复。', fdErrConsent: '请确认同意将本次需求转发给所选司机。',
    fdSubmit: '发送司机询价需求',
    fdBadge: '认证本地司机',
    fdFeat1: '巴厘岛本地司机，会讲英语', fdFeat2: '机场与酒店接送',
    fdFeat3: '全天包车游，10-12 小时', fdFeat4: '旅行者亲测靠谱',
    fdPriceLine1: '<strong>司机看过路线后报价</strong>',
    fdPriceNote: '档期、车辆、时长和价格都需要司机确认。',
    fdImportOk: '已从你最近的 AI 行程导入，可自行编辑。',
    fdImportNone: '还没有找到 AI 行程。可以先在 AI 工具里规划一次，或手动填写。',
    fdErrName: '请填写你的名字', fdErrContact: '请填写电子邮箱',
    fdSending: '发送中……', fdSuccessTitle: '需求已发送！',
    fdSuccessSub: '需求已进入司机确认流程，所选司机或 WanderMind 会通过邮件回复。',
  ...
  ja: {
    ...
    baliHeroSub: '6つのルートから目的を選び、日数、ペース、予算、同行者に合わせて調整します。',
    ...
    baliItinEyebrow: 'ルート例 · 12日', baliItinTitle: 'ディープルートの出発点',
    baliItinSub: '海岸、文化、火山、離島を組み合わせた例です。実際の条件に合わせて調整してください。',
    baliDayLbl: '日',
    ...
    baliDriverPrice1: '利用時間はドライバー確認', baliDriverPrice2: 'ルート確認後に見積もり', baliDriverPrice3: '空港＆ホテル送迎',
    ...
    fdStepTrip: '旅程', fdStepNeeds: 'ルートと希望', fdStepReview: '連絡先と送信',
    fdStepTripTitle: '旅程の基本情報', fdStepNeedsTitle: 'ルートと車の希望を追加', fdStepReviewTitle: '返信先を確認して送信',
    fdNext: '次へ', fdBack: '戻る', fdViewDriver: '選択したドライバーの詳細を見る',
    fdChooseDriver: 'ドライバーを選ぶ', fdDickyShort: 'バリ島の現地ドライバー', fdGedeShort: 'バリ島の現地ドライバー',
    ...
    fdContact: 'メールアドレス', fdContactHint: 'ドライバーへの依頼は WanderMind がメールで取り次ぎます。',
    fdEmailPh: 'メールアドレス',
    ...
    fdConsent: '返信のため、WanderMind がこの依頼と入力したメールアドレスを選択したドライバーへ転送することに同意します。', fdErrConsent: '選択したドライバーへの転送に同意してください。',
    fdSubmit: 'ドライバー依頼を送信',
    fdBadge: '認証済み現地ドライバー',
    fdFeat1: 'バリ島現地ドライバー、英語対応', fdFeat2: '空港・ホテル送迎',
    fdFeat3: '終日チャーター、10〜12時間', fdFeat4: '旅行者お墨付き・信頼できる',
    fdPriceLine1: '<strong>ルート確認後に見積もり</strong>',
    fdPriceNote: '空き状況、車両、時間、料金はドライバー確認が必要です。',
    fdImportOk: '最新のAIプランから取り込みました。自由に編集できます。',
    fdImportNone: 'AIプランがまだありません。先にAIツールで旅程を計画するか、手動で入力してください。',
    fdErrName: 'お名前を入力してください', fdErrContact: 'メールアドレスを入力してください',
    fdSending: '送信中…', fdSuccessTitle: 'リクエストを送信しました！',
    fdSuccessSub: 'ドライバー確認に送信されました。選択したドライバーまたは WanderMind がメールで返信します。',
  ...
  ko: {
    ...
    baliHeroSub: '6개 테마 루트에서 목적을 고른 뒤 일정, 속도, 예산, 동행자에 맞게 조정합니다.',
    ...
    baliItinEyebrow: '루트 예시 · 12일', baliItinTitle: '심층 루트의 출발점',
    baliItinSub: '해안, 문화, 화산, 섬 확장을 조합한 예시입니다. 실제 조건에 맞춰 조정하세요.',
    baliDayLbl: '일',
    ...
    baliDriverPrice1: '이용 시간은 기사 확인', baliDriverPrice2: '루트 검토 후 견적', baliDriverPrice3: '공항＆호텔 픽업',
    ...
    fdStepTrip: '여행', fdStepNeeds: '경로와 요청', fdStepReview: '연락처와 전송',
    fdStepTripTitle: '기본 여행 정보', fdStepNeedsTitle: '경로와 차량 요청 추가', fdStepReviewTitle: '답변 이메일 확인 후 전송',
    fdNext: '다음', fdBack: '이전', fdViewDriver: '선택한 기사 상세 보기',
    fdChooseDriver: '기사 선택', fdDickyShort: '발리 현지 기사', fdGedeShort: '발리 현지 기사',
    ...
    fdContact: '이메일 주소', fdContactHint: '기사 요청은 WanderMind가 이메일로 전달합니다.',
    fdEmailPh: '이메일 주소',
    ...
    fdConsent: '답변을 위해 WanderMind가 이 요청과 입력한 이메일 주소를 선택한 기사에게 전달하는 데 동의합니다.', fdErrConsent: '선택한 기사에게 요청을 전달하는 데 동의해 주세요.',
    fdSubmit: '기사 요청 보내기',
    fdBadge: '검증된 현지 기사',
    fdFeat1: '발리 현지 기사, 영어 가능', fdFeat2: '공항·호텔 픽업/드롭',
    fdFeat3: '종일 전세 투어, 10-12시간', fdFeat4: '여행자 인증·신뢰할 수 있음',
    fdPriceLine1: '<strong>루트 검토 후 견적</strong>',
    fdPriceNote: '가능 일정, 차량, 시간, 가격은 기사 확인이 필요합니다.',
    fdImportOk: '최근 AI 플랜에서 가져왔습니다. 자유롭게 수정하세요.',
    fdImportNone: '아직 AI 플랜이 없습니다. 먼저 AI 도구에서 여행을 계획하거나 직접 작성하세요.',
    fdErrName: '이름을 입력하세요', fdErrContact: '이메일 주소를 입력하세요',
    fdSending: '전송 중…', fdSuccessTitle: '요청을 보냈습니다!',
    fdSuccessSub: '기사 검토 요청이 전송되었습니다. 선택한 기사 또는 WanderMind가 이메일로 답변합니다.',
  ...
  id: {
    ...
    partnerDickyCta: 'Mulai permintaan driver privat →',
    ...
    fdContactViaForm: 'Pilih driver di formulir sebelah kiri; permintaan Anda akan kami teruskan secara privat.',
    ...
    baliHeroSub: 'Pilih satu dari enam keluarga rute, lalu sesuaikan hari, tempo, anggaran, dan teman perjalanan.',
    ...
    baliItinEyebrow: 'Contoh rute · 12 hari', baliItinTitle: 'Titik awal rute mendalam',
    baliItinSub: 'Contoh ini memadukan pesisir, budaya, gunung berapi, dan ekstensi pulau. Sesuaikan dengan kondisi nyata Anda.',
    baliDayLbl: 'Hari',
    ...
    baliDriverPrice1: 'Durasi dikonfirmasi driver', baliDriverPrice2: 'Harga setelah rute ditinjau', baliDriverPrice3: 'Jemput bandara & hotel',
    ...
    fdStepTrip: 'Perjalanan', fdStepNeeds: 'Rute & kebutuhan', fdStepReview: 'Kontak & kirim',
    fdStepTripTitle: 'Mulai dari detail perjalanan', fdStepNeedsTitle: 'Lengkapi rute dan kebutuhan mobil', fdStepReviewTitle: 'Konfirmasi email balasan dan kirim',
    fdNext: 'Berikutnya', fdBack: 'Kembali', fdViewDriver: 'Lihat profil lengkap driver pilihan',
    fdChooseDriver: 'Pilih driver', fdDickyShort: 'Driver lokal Bali', fdGedeShort: 'Driver lokal Bali',
    ...
    fdContact: 'Alamat email Anda', fdContactHint: 'Permintaan driver diteruskan oleh WanderMind melalui email.',
    fdEmailPh: 'Alamat email',
    ...
    fdConsent: 'Saya setuju WanderMind meneruskan permintaan ini dan alamat email yang saya isi kepada driver pilihan saya untuk mengatur balasan.', fdErrConsent: 'Harap setujui pengiriman permintaan kepada driver pilihan Anda.',
    ...
    fdPriceLine1: '<strong>Harga setelah rute ditinjau</strong>',
    fdPriceNote: 'Ketersediaan, kendaraan, durasi, dan harga perlu dikonfirmasi driver.',
    ...
    fdErrName: 'Masukkan nama Anda', fdErrContact: 'Masukkan alamat email',
    fdSending: 'Mengirim…', fdSuccessTitle: 'Permintaan terkirim!',
    fdSuccessSub: 'Permintaan dikirim untuk ditinjau. Driver pilihan atau WanderMind akan membalas melalui email.',
...
Object.assign(LANGS.ko, { fdStartDate:'시작일 <span class="fd-req">*</span>', fdEndDate:'종료일 <span class="fd-req">*</span>', fdPickupTime:'희망 픽업 시간', fdPickupLocation:'호텔 / 픽업 장소', fdPickupPh:'정해졌다면 호텔 또는 지역', fdBudget:'예상 총예산', fdBudgetFlexible:'유연함 / 먼저 상담', fdBudget1:'500만 IDR 미만', fdBudget2:'500–1,000만 IDR', fdBudget3:'1,000–2,000만 IDR', fdBudget4:'2,000만 IDR 이상', fdServices:'함께 상담할 서비스', fdServiceCar:'전용 차량 / 기사', fdServiceAirport:'공항 이동', fdServiceHotel:'호텔 추천', fdServiceBoat:'사누르 출발 보트', fdServiceFlight:'항공편 연계', fdServiceTickets:'관광지 티켓', fdBundleHint:'통합 견적 요청이며 즉시 예약이 아닙니다. 이용 가능 여부와 제공 업체는 답변에서 확인합니다.', fdArrival:'항공편·보트·도착 정보', fdArrivalPh:'항공편 번호, 도착 시간, 사누르 보트 날짜 등', fdErrDates:'유효한 여행 날짜를 입력하세요' });
...
Object.assign(LANGS.ja,{fdFirstLabel:'名 <span class="fd-req">*</span>',fdLastLabel:'姓 <span class="fd-req">*</span>'});
Object.assign(LANGS.ko,{fdFirstLabel:'이름 <span class="fd-req">*</span>',fdLastLabel:'성 <span class="fd-req">*</span>'});
Object.assign(LANGS.id,{fdFirstLabel:'Nama depan <span class="fd-req">*</span>',fdLastLabel:'Nama belakang <span class="fd-req">*</span>'});
Object.assign(LANGS.en, { baliFilterAll:'All real moments', baliFilterNature:'Nature', baliFilterCulture:'Culture', baliFilterExperience:'Experiences', baliFilterTraveler:'Traveller viewpoint', baliFilterComposed:'Composed scenery', baliTagNature:'Nature', baliTagCulture:'Culture', baliTagExperience:'Experience', baliTagTraveler:'Traveller shot', baliTagComposed:'Composed view', baliMiniRoute:'Simple route', baliAddRoute:'Add to my AI route', baliAskLocal:'Ask a local driver' });
Object.assign(LANGS.zh, { baliFilterAll:'全部真实瞬间', baliFilterNature:'自然风景', baliFilterCulture:'人文文化', baliFilterExperience:'亲身体验', baliFilterTraveler:'游客手机视角', baliFilterComposed:'风景构图', baliTagNature:'自然', baliTagCulture:'人文', baliTagExperience:'体验', baliTagTraveler:'游客视角', baliTagComposed:'风景构图', baliMiniRoute:'简易路线', baliAddRoute:'加入我的 AI 路线', baliAskLocal:'咨询本地司机' });
Object.assign(LANGS.ja, { baliFilterAll:'すべての実景', baliFilterNature:'自然', baliFilterCulture:'文化', baliFilterExperience:'体験', baliFilterTraveler:'旅行者の視点', baliFilterComposed:'風景構図', baliTagNature:'自然', baliTagCulture:'文化', baliTagExperience:'体験', baliTagTraveler:'旅行者撮影', baliTagComposed:'風景構図', baliMiniRoute:'簡単ルート', baliAddRoute:'AIルートに追加', baliAskLocal:'現地ドライバーに相談' });
Object.assign(LANGS.ko, { baliFilterAll:'모든 실제 순간', baliFilterNature:'자연', baliFilterCulture:'문화', baliFilterExperience:'체험', baliFilterTraveler:'여행자 시점', baliFilterComposed:'풍경 구도', baliTagNature:'자연', baliTagCulture:'문화', baliTagExperience:'체험', baliTagTraveler:'여행자 촬영', baliTagComposed:'풍경 구도', baliMiniRoute:'간단 경로', baliAddRoute:'AI 경로에 추가', baliAskLocal:'현지 기사에게 문의' });
Object.assign(LANGS.id, { baliFilterAll:'Semua momen nyata', baliFilterNature:'Alam', baliFilterCulture:'Budaya', baliFilterExperience:'Pengalaman', baliFilterTraveler:'Sudut pandang traveler', baliFilterComposed:'Komposisi pemandangan', baliTagNature:'Alam', baliTagCulture:'Budaya', baliTagExperience:'Pengalaman', baliTagTraveler:'Foto traveler', baliTagComposed:'Komposisi', baliMiniRoute:'Rute sederhana', baliAddRoute:'Tambahkan ke rute AI', baliAskLocal:'Tanya driver lokal' });
Object.assign(LANGS.en, { baliFilterTheme:'Travel theme', baliFilterTags:'Photo & travel tags', baliFilterLandscapes:'Landscapes', baliFilterExperiences:'Experiences', baliFilterPlaces:'Places', baliFilterAllTags:'All tags', baliTagTravellerMoment:'Traveller moment', baliTagGoldenHour:'Golden hour', baliTagAdventure:'Adventure', baliTagDocumentary:'Documentary', baliSubAdventure:'Adventure', baliSubOceanBeach:'Ocean & Beach', baliSubIconic:'Iconic attraction', baliSubArtHeritage:'Art & Heritage', baliSubTemples:'Temples & Architecture', baliSubFoodJourney:'Food journey', baliSubLocalLifestyle:'Local lifestyle', baliSubMountainsVolcano:'Mountains & Volcano', baliSubHotels:'Hotels & Resorts', baliSubRoadTrip:'Road trip & transfers', baliGalleryEmpty:'No current image matches both filters. Try another tag.' });
Object.assign(LANGS.zh, { baliFilterTheme:'旅行内容', baliFilterTags:'拍摄与旅行标签', baliFilterLandscapes:'自然风光', baliFilterExperiences:'旅行体验', baliFilterPlaces:'地点精选', baliFilterAllTags:'全部标签', baliTagTravellerMoment:'游客真实瞬间', baliTagGoldenHour:'日出日落光线', baliTagAdventure:'户外探索', baliTagDocumentary:'纪实视角', baliSubAdventure:'户外体验', baliSubOceanBeach:'海洋与海岸', baliSubIconic:'代表性地点', baliSubArtHeritage:'艺术与文化遗产', baliSubTemples:'寺庙与建筑', baliSubFoodJourney:'饮食与咖啡', baliSubLocalLifestyle:'当地生活', baliSubMountainsVolcano:'山地与火山', baliSubHotels:'住宿与度假空间', baliSubRoadTrip:'公路与接驳', baliGalleryEmpty:'当前没有同时符合这两个条件的图片，请换一个标签。' });
...
Object.assign(LANGS.en, { baliRouteSectionEyebrow:'Free route library', baliRouteSectionTitle:'Browse complete public routes for free', baliRouteSectionSub:'Explore R1–R6 in full. Personal professional routes reveal about 70% first; unlock all places and execution details.', baliProfessionalEyebrow:'Personalised professional route', baliProfessionalTitle:'Match a route from your trip profile', baliProfessionalSub:'Separate from AI DIY, with its own access and three adjustments.' });
Object.assign(LANGS.zh, { baliRouteSectionEyebrow:'免费公共路线', baliRouteSectionTitle:'公共路线家族可免费完整浏览', baliRouteSectionSub:'R1–R6 免费完整浏览；个性化专业路线先预览约 70%，解锁后查看全部地点与执行细节。', baliProfessionalEyebrow:'个性化专业路线', baliProfessionalTitle:'根据旅行信息匹配专业路线', baliProfessionalSub:'与 AI 自助规划相互独立，解锁后包含 3 次同一行程调整。' });
Object.assign(LANGS.ja, { baliRouteSectionEyebrow:'無料の公開ルート', baliRouteSectionTitle:'公開ルートはすべて無料で閲覧できます', baliRouteSectionSub:'R1〜R6を無料で全て確認。個別プロルートは約70%を先行表示し、解除後に全スポットと実行詳細を確認できます。', baliProfessionalEyebrow:'個別プロルート', baliProfessionalTitle:'旅行情報からプロルートを提案', baliProfessionalSub:'AIセルフプランとは別枠で、解除後は同じ旅程を3回調整できます。' });
...
Object.assign(LANGS.en, {
  ...
  privacyTitle:'Your trip details should stay yours.', privacyIntro:'WanderMind collects only what is needed to run accounts, plan routes, relay a driver request and understand whether our own launch pages work.', privacyUpdated:'Updated 27 August 2026',
  ...
  privacyPaymentTitle:'Payments and route access', privacyPaymentBody:'If you choose PayPal, PayPal processes your payment details under its own privacy terms. WanderMind does not receive or store your card number. We retain the order identifier, amount, currency, payment status and limited capture or refund references needed to grant route access, prevent duplicate unlocks and handle support or refund review.',
...
Object.assign(LANGS.zh, {
  ...
  privacyTitle:'你的行程信息，应当由你掌控。', privacyIntro:'WanderMind 只收集维持账户、规划路线、转发司机需求，以及判断首发页面是否有效所必需的信息。', privacyUpdated:'更新于 2026 年 8 月 27 日',
  ...
  privacyPaymentTitle:'付款与路线权益', privacyPaymentBody:'如果选择 PayPal，付款资料由 PayPal 按其隐私条款处理；WanderMind 不接收或保存你的银行卡号。我们只保留授予路线权益、防止重复解锁，以及处理客服或退款复核所需的订单编号、金额、币种、付款状态和有限的收款或退款编号。',
...
Object.assign(LANGS.ja, {
  ...
  privacyTitle:'旅の情報は、あなたのものです。', privacyIntro:'WanderMind は、アカウント、ルート作成、ドライバー依頼の転送、公開ページの改善に必要な情報だけを扱います。', privacyUpdated:'2026年8月27日更新',
  ...
  privacyPaymentTitle:'決済とルート利用権', privacyPaymentBody:'PayPalを選ぶと、決済情報はPayPalのプライバシー条件に基づき処理されます。WanderMindはカード番号を受領・保存しません。利用権付与、重複解放の防止、サポートや返金確認に必要な注文番号、金額、通貨、決済状態、限定的な決済・返金参照だけを保持します。',
...
Object.assign(LANGS.ko, {
  ...
  privacyTitle:'여행 정보의 주인은 이용자입니다.', privacyIntro:'WanderMind는 계정 운영, 경로 계획, 기사 요청 전달과 출시 페이지 개선에 필요한 정보만 처리합니다.', privacyUpdated:'2026년 8월 27일 업데이트',
  ...
  privacyPaymentTitle:'결제 및 경로 이용 권한', privacyPaymentBody:'PayPal을 선택하면 결제 정보는 PayPal의 개인정보 조건에 따라 처리됩니다. WanderMind는 카드 번호를 받거나 저장하지 않습니다. 경로 이용 권한 부여, 중복 잠금 해제 방지, 지원 또는 환불 검토에 필요한 주문 ID, 금액, 통화, 결제 상태와 제한된 결제·환불 참조만 보관합니다.',
...
Object.assign(LANGS.id, {
  ...
  privacyTitle:'Detail perjalanan Anda tetap milik Anda.', privacyIntro:'WanderMind hanya memproses informasi yang diperlukan untuk akun, perencanaan rute, meneruskan permintaan driver, dan memahami apakah halaman peluncuran kami bekerja.', privacyUpdated:'Diperbarui 27 Agustus 2026',
  ...
  privacyPaymentTitle:'Pembayaran dan akses rute', privacyPaymentBody:'Jika memilih PayPal, detail pembayaran diproses oleh PayPal sesuai ketentuan privasinya. WanderMind tidak menerima atau menyimpan nomor kartu. Kami hanya menyimpan ID pesanan, jumlah, mata uang, status pembayaran, serta referensi pembayaran atau refund terbatas untuk membuka rute, mencegah pembukaan ganda, dan menangani dukungan atau peninjauan refund.',
