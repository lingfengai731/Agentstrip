(function () {
  ...
  function renderResult() {
    ...
    var editor = state.editing ? '<div class="bali-professional-card" id="bali-professional-editor" style="margin-top:20px"><h3>' + esc(l.formTitle) + '</h3>' + formMarkup(p) + '</div>' : '';
