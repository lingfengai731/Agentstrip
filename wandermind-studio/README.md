...
| **巴厘岛事实核验** | 50 个 POI 分离“稳定事实已核验”和“实时信息待复核”；R1 主干 15 个地点已核验、火山 Jeep 单独等待供应商，R3 的 8 个主路线地点已全部核验；全库 19 个 verified、30 个 pending、1 个 supplier confirmation，均保留出发前 live checks |
