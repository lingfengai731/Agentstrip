...
| **巴厘岛事实核验** | 59 个 POI 分离“稳定事实已核验”和“实时信息待复核”；R1 主干、R2、R3、R4 与 R6 的免费路线稳定事实已核验；全库 53 个 `verified`、3 个 `pending_review`、3 个 `needs_supplier_confirmation`，均保留出发前 live checks 与供应商门禁 |
