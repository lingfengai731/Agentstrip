...
class ProductAccessTests(unittest.TestCase):
    ...
    def test_frontend_has_separate_professional_and_ai_entry_contracts(self):
        ...
        self.assertIn("assets/js/bali-professional.js?v=20260901p65", bali_html)
    ...
    def test_portfolio_admin_page_uses_direct_signed_upload_and_automatic_suggestions(self):
        frontend = BACKEND_DIR.parents[1] / "wandermind-studio" / "frontend"
        ...
        self.assertIn("admin-portfolio.js?v=20260901p8", admin_html)
        ...
        self.assertIn("metadata.admin_approval = status === 'published'", admin_js)
        self.assertIn("record.metadataEdited", admin_js)
        self.assertNotIn("publishNeedsManifestReview", admin_js)
        self.assertNotIn("isApprovedPortfolioAsset", admin_js)
        self.assertNotIn("manifestApprovalRequired", admin_js)
        ...
        self.assertNotIn('name="admin_approval"', admin_html)
        self.assertIn("rightsNotice", admin_js)
